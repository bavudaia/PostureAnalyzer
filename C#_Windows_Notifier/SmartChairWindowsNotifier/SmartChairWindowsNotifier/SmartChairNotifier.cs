...
namespace SmartChairWindowsNotifier
{
    class SmartChairNotifier
    {
        ...
        public SmartChairNotifier()
        {
           ...
           // System.Net.IPAddress ipaddress = System.Net.IPAddress.Parse("54.149.181.1");
            // client = new MqttClient(ipaddress,2882,false,null,null, MqttSslProtocols.None);
            client = new MqttClient("ec2-54-218-1-206.us-west-2.compute.amazonaws.com", 2880, false, null, null, MqttSslProtocols.None, null);
        ...
        private void Client_MqttMsgPublishReceived(object sender, uPLibrary.Networking.M2Mqtt.Messages.MqttMsgPublishEventArgs e)
        {
            ...
            {
                notifyIcon.ShowBalloonTip("Smart Chair Notification", "You are sitting in harmful position", Properties.Resources.Led);
